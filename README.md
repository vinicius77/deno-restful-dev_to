...
Please, read the [Deno](https://github.com/denoland/deno_install/blob/master/README.md) Documentation if you are not using Ubuntu as I am.
...
- **GET:** http://127.0.0.1:5000/javascript/books
- **POST:** http://127.0.0.1:5000/javascript/books
- **DELETE:** http://127.0.0.1:5000/javascript/books/:id
- **PUT:** http://127.0.0.1:5000/javascript/books/:id
